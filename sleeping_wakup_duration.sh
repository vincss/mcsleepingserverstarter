...
# where it says 'Done!' and some time that was needed for loading all your 	#
# files and chunks. 								#
#################################################################################
...
#looking through the logs with grep and calculating the average startup time with awk
...
# sed replaces the whole line 'loginMessage' is in with 'newLoginMessageLine'
