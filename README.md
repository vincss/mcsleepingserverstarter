...
| `whitelistFileUsernameOnly` | Check only the username in the `whitelist.json` file, ignoring the UUID. Useful if you when the server is in online-mode=false and the UUIDs are not consistent.                                                                         | false                                           |
